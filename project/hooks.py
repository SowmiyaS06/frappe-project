...
# 		"title": "Project",
# 		"route": "/project",
# 		"has_permission": "project.api.permission.has_app_permission",
# 	}
# ]
...
# `project/dock/project/project.json` for git to carry. An app that ships none has no
...
# app_include_icons = "project/public/icons.svg"
...
# setup_wizard_url = "/project/setup"
...
# before_disable = "project.uninstall.before_disable"
# after_disable = "project.uninstall.after_disable"
# before_enable = "project.install.before_enable"
# after_enable = "project.install.after_enable"
...
# before_app_install = "project.utils.before_app_install"
# after_app_install = "project.utils.after_app_install"
...
# before_app_uninstall = "project.utils.before_app_uninstall"
# after_app_uninstall = "project.utils.after_app_uninstall"

# Build
# ------------------
# To hook into the build process

# after_build = "project.build.after_build"

# To hook into the build process of other apps
# The list of apps being built is passed as an argument

# after_app_build = "project.build.after_app_build"
...
# awesomebar_search = ["project.search.awesomebar_results"]
...
# 	"Task": "project.custom.task.CustomTaskMixin"
# }
...
# Request Events
# ----------------
# before_request = ["project.utils.before_request"]
# after_request = ["project.utils.after_request"]

# Job Events
# ----------
# before_job = ["project.utils.before_job"]
# after_job = ["project.utils.after_job"]

# after_file_upload = ["project.utils.after_file_upload"]
...
app_include_js = "/assets/project/js/ch6.js"
